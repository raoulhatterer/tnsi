...
!!! abstract "{{ exercice() }} : création d'une rainbow table :rainbow:"
    ...
    **Aide :**
    ...
    - liste de 1000 mots de passe fréquents : [ici](./data/extraitrockyou.txt)
...
!!! abstract "{{ exercice() }}"
    Exercice 2 du sujet [Centres Etrangers J1 2021](https://raoulhatterer.github.io/tnsi/T6_Annales/data/2021/21_Centres_Etrangers_1.pdf){. target="_blank"}
